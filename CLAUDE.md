...
4. ⬅️ **Package** *(NEXT)* — PyInstaller "localhost app" per OS; optional pywebview native build. `opencv` / `pyaudio` stay optional ("enable hardware" extra) so the base build is lean and cross-platform-clean.
