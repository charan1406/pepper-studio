...
PEPPER_SYSTEM = (
    ...
    "3. FACTS: For anything you are not certain of — weather, news, scores, prices, dates, "
    "times — a web search is run for you automatically. Answer directly and confidently "
    "from what comes back. Never guess a fact from memory. Never say you will check, look "
    "it up, or get back to them. If the results truly lack it, say so in one short sentence.\n"
